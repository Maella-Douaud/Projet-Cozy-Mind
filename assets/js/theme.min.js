...
"undefined" != typeof AOS && AOS.init({
    ...
    function() {
        ...
        function n() {
            a && o && (t.classList.remove("navbar-light"), t.classList.remove("bg-black"), t.classList.remove("border-bottom"), t.classList.add("navbar-dark"), t.style.display = "none", t.offsetHeight, t.style.display = "block", a = !1)
        }

        function r() {
            var e = window.pageYOffset;
            0 < e && !a ? !a && o && (t.classList.remove("navbar-dark"), t.classList.add("navbar-light"), t.classList.add("bg-black"), t.classList.add("border-bottom"), a = !0) : (0 == e || e < 0 && a) && n()
        }
